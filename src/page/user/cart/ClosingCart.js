          ...
          <div className="box-1">
            <div>
              ...
              <div className="customer_info">
                <p className="customer_info--name">Nguyễn Thị Ngọc</p>
                <i></i>
                <p class="customer_info__phone">0389332572</p>
              </div>

              <div class="address">
                {" "}
                <span class="address__type address__type--home">Nhà</span> km10, Nguyễn Trãi , Hà Đông , Hà Nội
              </div>
            </div>
          </div>
          <div className="box-2">
